...
// Mensagens padrao
define('STD_MSG_EXCEPTION', 'EXCEPTION');
define('STD_MSG_NOT_FOUND', 'NOT_FOUND');
define('STD_MSG_CREATED', 'CREATED');
...
define('SENTIDO_CONEXAO_ESQUERDA', 'left');
define('SENTIDO_CONEXAO_DIREITA', 'right');
