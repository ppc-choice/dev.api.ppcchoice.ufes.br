...
$route['cursos/(:num)/projetos-pedagogicos-curso']['GET'] = 'ProjetoPedagogicoCursoController/findByCodCurso/$1';
...
$route['projetos-pedagogicos-curso/(:num)/dependencias']['GET'] = 'DependenciaController/findByCodPpc/$1';
