...
class DepartamentoController extends APIController 
{
	 ...
	 * @apiSuccess {String} nomeUnidadeEnsino   Nome da Unidade de Ensino na qual o Departamento está registrado.
	 * @apiSuccess {String} nomeIes   Nome da Instituição de Ensino Superior na qual o Departamento está registrado.
	 * 
	 * @apiError {String[]} error Entities\\Departamento: Instância não encontrada.
	 */
